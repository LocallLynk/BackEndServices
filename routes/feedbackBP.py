...
feedback_blueprint.route('/', methods=['POST'])(create_feedback)
...
feedback_blueprint.route('/client_neighbor/<client_neighbor_id>', methods=['PUT'])(update_client_neighbor_feedback_rating)
