...
from controllers.shareController import add_share, remove_share, get_all_shares, get_share_by_id, update_share
...
share_blueprint.route('/', methods=['GET'])(get_all_shares)
